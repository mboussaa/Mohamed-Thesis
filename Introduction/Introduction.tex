...
On the other hand, compilers are needed to transform automatically the high-level source code programs, that were manually written or automatically generated, into low-level machine code (i.e., binaries, executables). 
...
In addition, modern generators (e.g., C compilers) become highly configurable, offering
...
Nevertheless, it is crucial that the software being automatically generated undergoes an appropriate verification and validation technique to verify the correct behavior of generators. Therefore, users can trust the generator and gain confidence in its correct functioning. 
...
Nevertheless, it is crucial that the software being automatically generated undergoes an appropriate verification and validation technique to determine that the code generator has generated correct code. Therefore, users can trust the code generator and gain confidence in its correct \replaced{operation}{functioning}. 
...
As we stated in the context of this thesis, today's modern code generators are highly configurable, letting the user \deleted{to} easily customize the automatically generated code. In the meantime, efficiently testing configurable code generators \replaced{poses}{pose} important challenges since it is too costly to manually or automatically execute and test all configurations. 
