...
On the one hand, code generators are needed to transform the high-level system specifications (e.g., textual or graphical modeling language) into conventional source code programs (e.g., General-purpose Languages GPLs such as Java, C++, etc). Automatic code generation can \deleted{of course} improve the quality and consistency of a program as well \added{as} the productivity of software development~\cite{kapteijns2009comparative}.
