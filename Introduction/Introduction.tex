...
\textbf{Contribution I: Automatic detection of inconsistencies within code generators families.}
...
\textbf{Contribution II: Automatic compiler auto-tuning according to the non-functional requirements.}
