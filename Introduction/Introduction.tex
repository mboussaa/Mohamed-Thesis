...
The huge design space of compiler configurations that fit the user requirements as well as the complexity of code generators make the activities of design, implementation, and testing very hard and time-consuming\cite{guana2015developers}.
