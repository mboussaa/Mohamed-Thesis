...
This thesis addresses three problems: 
	...
	(1) the problem of non-functional testing of code generators: 
	
	(2) the problem of automatically auto-tuning compilers through the runtime execution and evaluation of the generated code:  We use search-based software engineering techniques in order to help compiler users to choose the best configuration that satisfy specific non-functional requirements and lead to performance improvement.


	(3) the problem of           : For this purpose, we benefit from the recent advances in lightweight system virtualization ,in particular container-based virtualization, in order to offer effective support for deploying, monitoring, and testing the generated code.
