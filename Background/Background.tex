...
As \added{a} consequence, people who are writing compilers have to continuously enhance the way these executables are produced by releasing new compiler versions to support new hardware changes (\ie, introducing new optimization flags, instruction sets, etc.). 
\begin{figure}[h]
	\center
...
\begin{itemize}
	...
	\end{table}
	This table shows how huge is the code generator base code. With more than \num{1800000} lines of code, it is very hard to test \replaced{the}{thz} whole system. 
