...
\cite{he2010computer} argue that system software is not ready for this heterogeneity and cannot fully benefit from new hardware advances such as multi-core and many-core processors. Although multi-core processors has been used in everyday’s life, we still do not know how to best organize and use them. 
...
% Software arestguliing with hetergenouity. If we add hetergenousty can we deal with that
 %What we have to do as software community to adress hetergenouity, we need some part of the work load or some ubiquity because hardware specialization for every single application is not a sustainable way of building chips
