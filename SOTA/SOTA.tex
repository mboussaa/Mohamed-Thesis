...
\begin{itemize}
	...
	Deviations in behavior are indicative of compiler inconsistencies.
	...
	Another application of the equivalence based method is presented by Tao et al.\cite{tao2010automatic} to test the semantic-soundness property of compilers. They used three different techniques in generating equivalent source programs and tested the mutants with the programs. Empirical results show that their approach is able two real issues in real errors in GCC and UCC compilers.
