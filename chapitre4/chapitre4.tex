...
\begin{figure}
	\centering  
	\subfigure[R-chart of the Core benchmark program]{\includegraphics[width=0.96\linewidth]{chapitre4/fig/1.png}}
	\subfigure[R-chart of the Color benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/2.png}}
	\subfigure[R-chart of the Hxmath benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/3.png}}
	\subfigure[R-chart of the Format benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/4.png}}
	\subfigure[R-chart of the Promise benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/5.png}}
	\subfigure[R-chart of the Culture benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/6.png}}
	\subfigure[R-chart of the Math benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/7.png}}
	\caption{Performance variation of test suites across the different Haxe benchmarks}
\end{figure}

\begin{figure}
	\centering  
	\subfigure[R-chart of the Core benchmark program]{\includegraphics[width=0.96\linewidth]{chapitre4/fig/11.png}}
	\subfigure[R-chart of the Color benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/22.png}}
	\subfigure[R-chart of the Hxmath benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/33.png}}
	\subfigure[R-chart of the Format benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/44.png}}
	\subfigure[R-chart of the Promise benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/55.png}}
	\subfigure[R-chart of the Culture benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/66.png}}
	\subfigure[R-chart of the Math benchmark program]{\includegraphics[width=0.48\linewidth]{chapitre4/fig/77.png}}
...
\begin{figure}
	\centering  
	\subfigure[Test suites relative to the execution times ]{\includegraphics[width=0.7\linewidth]{chapitre4/fig/explor_ind}}
	\subfigure[Test suites relative to the memory consumptions]{\includegraphics[width=0.7\linewidth]{chapitre4/fig/explor_ind2}}
	
	\caption{PCAs showing the dispersion of our data over the PC subspace}
\end{figure}
\begin{figure}
	\centering  
	\subfigure[Performance deviations]{\includegraphics[width=0.49\linewidth]{chapitre4/fig/mahatime}}
	\subfigure[Memory usage deviations]{\includegraphics[width=0.49\linewidth]{chapitre4/fig/mahamem}}
...
\paragraph{Inconsistencies detected}~\\
