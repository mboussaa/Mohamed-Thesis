...
\input{Introduction/IntroductionFr.tex}
...
\chapter{Automatic non-functional testing of code generators families}\label{chap:code generators}
\input{chapitre4/chapitre4.tex}
\chapter{NOTICE: An approach for auto-tuning compilers}\label{chap:compilers}
\input{chapitre3/chapitre3.tex}
\chapter{A lightweight execution environment for automatic software testing and optimization}\label{chap:docker}
