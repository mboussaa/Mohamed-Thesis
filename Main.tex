...
\addtocounter{page}{-1}%ça c'est pour revenir 
...
\chapter[Automatic non-functional testing of code generator families]{Automatic non-functional testing of code generators families}\label{chap:code generators}
