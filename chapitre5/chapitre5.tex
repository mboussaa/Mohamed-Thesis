...
The Linux kernel provides the control groups (Cgroups) functionality that allows the limitation and prioritization of resources (CPU, memory, block I/O, network, etc.) of each container without the need of starting any virtual machines~\cite{luotowards}.
...
When testing or tuning generators (in Chapter \ref{chap:code generators} and \ref{chap:compilers}), we proceed as follows:
